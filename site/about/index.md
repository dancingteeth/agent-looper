...
The project is MIT-licensed, inspectable, and runtime-agnostic: Cursor, Cline, OpenCode, Pi, Codex, DSH, and Muse Code (in testing). Models stay whoever you already pay. What you own is the loop — frozen goal, measurable `verify.sh`, sparse `REVIEWS.md` / `AGENTS.md`, and orchestration that keeps workers fresh and spend bounded.

Agent Looper is made by Paul Zgordan (dancingteeth), who also writes at The Vacuum Cleaner Gets Smart and ships other tools under the dancingteeth name. This site is the product landing for the harness, not a company brochure.
