...
The project is MIT-licensed, inspectable, and runtime-agnostic: Cursor, Cline, OpenCode, Pi, Codex, DSH, and Muse. Models stay whoever you already pay. What you own is the loop — frozen goal, measurable `verify.sh`, sparse `REVIEWS.md` / `AGENTS.md`, and orchestration that keeps workers fresh and spend bounded.
