...
Need Claude Code? Put `claude` 2.1.169+ on PATH, run `claude login`, leave `ANTHROPIC_API_KEY` unset, use `--runtime claude` (or `reviewRuntime: claude` for an Opus judge).
