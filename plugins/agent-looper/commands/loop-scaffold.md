...
3. Copy structure from harness templates (`GOAL.template.md`, `verify.example.sh`, `loop.json.example`) or run `pnpm exec agent-loop-init` if the repo has no profile yet.
